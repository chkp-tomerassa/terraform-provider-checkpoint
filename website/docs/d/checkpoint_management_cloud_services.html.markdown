...
* `environment_id` - The connected environment's ID in the Infinity Portal.
...
* `enabled` - Enable/Disable automatic connection of Security Gateways to Infinity Portal.
