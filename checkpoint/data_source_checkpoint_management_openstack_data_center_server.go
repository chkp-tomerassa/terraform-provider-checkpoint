...
func dataSourceOpenStackDataCenterServerRead(d *schema.ResourceData, m interface{}) error {
	...
	if v := openstackDataCenterServer["automatic-refresh"]; v != nil {
		_ = d.Set("automatic_refresh", v)
	}

	if v := openstackDataCenterServer["data-center-type"]; v != nil {
		_ = d.Set("data_center_type", v)
	}

	if v := openstackDataCenterServer["properties"]; v != nil {
