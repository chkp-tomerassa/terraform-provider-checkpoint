...
func dataSourceManagementVoipDomainSccpCallManager() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceManagementVoipDomainSccpCallManagerRead,
...
func dataSourceManagementVoipDomainSccpCallManagerRead(d *schema.ResourceData, m interface{}) error {
	...
	if v := voipDomainSccpCallManager["uid"]; v != nil {
		d.SetId(v.(string))
	}
	...
	if v := voipDomainSccpCallManager["icon"]; v != nil {
		_ = d.Set("icon", v)
	}
