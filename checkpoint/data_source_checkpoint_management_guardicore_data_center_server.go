...
func dataSourceGuardicoreDataCenterServerRead(d *schema.ResourceData, m interface{}) error {
	...
	if v := guardicoreDataCenterServer["automatic-refresh"]; v != nil {
		_ = d.Set("automatic_refresh", v)
	}

	if v := guardicoreDataCenterServer["data-center-type"]; v != nil {
		_ = d.Set("data_center_type", v)
	}

	if v := guardicoreDataCenterServer["properties"]; v != nil {
