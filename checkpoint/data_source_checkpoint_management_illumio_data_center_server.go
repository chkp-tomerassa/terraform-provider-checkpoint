...
func dataSourceManagementIllumioDataCenterServer() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceIllumioDataCenterServerRead,
...
func dataSourceIllumioDataCenterServerRead(d *schema.ResourceData, m interface{}) error {
	...
	if v := illumioDataCenterServer["uid"]; v != nil {
		_ = d.Set("uid", v)
		d.SetId(v.(string))
	}
