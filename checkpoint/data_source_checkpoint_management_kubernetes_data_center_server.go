...
func dataSourceKubernetesDataCenterServerRead(d *schema.ResourceData, m interface{}) error {
	...
	if v := kubernetesDataCenterServer["automatic-refresh"]; v != nil {
		_ = d.Set("automatic_refresh", v)
	}

	if v := kubernetesDataCenterServer["data-center-type"]; v != nil {
		_ = d.Set("data_center_type", v)
	}

	if v := kubernetesDataCenterServer["properties"]; v != nil {
