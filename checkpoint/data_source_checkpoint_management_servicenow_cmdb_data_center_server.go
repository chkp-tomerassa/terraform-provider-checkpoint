...
func dataSourceManagementServicenowCmdbDataCenterServer() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceServicenowCmdbDataCenterServerRead,
...
func dataSourceServicenowCmdbDataCenterServerRead(d *schema.ResourceData, m interface{}) error {
	...
	if v := servicenowCmdbDataCenterServer["uid"]; v != nil {
		_ = d.Set("uid", v)
		d.SetId(v.(string))
	}
	...
	if v := servicenowCmdbDataCenterServer["automatic-refresh"]; v != nil {
		_ = d.Set("automatic_refresh", v)
	}

	if v := servicenowCmdbDataCenterServer["data-center-type"]; v != nil {
		_ = d.Set("data_center_type", v)
	}

	if v := servicenowCmdbDataCenterServer["properties"]; v != nil {
